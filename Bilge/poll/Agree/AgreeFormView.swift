                ...
                GButton(labelText: "Save",
                    ...
                    withAnimation(.easeInOut(duration: 0.4)) {
                        if question.isEmpty {
                            ...
                            let component = Agree(question: question,
                                                      time: selection)
                            
                            let counters = pollManager.counters
                            var count = counters[PollComponentType.agree.toString()] ?? 0
                            count+=1
                            
                            pollManager.counters[PollComponentType.agree.toString()] = count
...
struct AgreeFormView_Previews: PreviewProvider {
